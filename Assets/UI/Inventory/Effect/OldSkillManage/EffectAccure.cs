...
public class EffectAccure : MonoBehaviour
{
    ...
    GameObject Attack1HurtedEffect;
    ...
    public GameObject attack1HurtedPrefab;
    ...
    public void ActiveAttack1HurtedEffect()
    {
        Vector3 offset2 = new Vector3(0, 0, -20);
        Attack1HurtedEffect = Instantiate(attack1HurtedPrefab, transform.position + offset2, Quaternion.identity);
        Animator animator = Attack1HurtedEffect.GetComponent<Animator>();
        animator.SetTrigger("Effect");
    }
